...
(function () {
  ...
  function resolvePlaceholders(s) {
    ...
    return {
      ...
      facturaNum:       v("55_1"),
      facturaFecha,
      proveedorNombre:  (s["dj_proveedor_nombre"] && s["dj_proveedor_nombre"].trim()) || "TESLA MOTORS COLOMBIA, S.A.S.",
      proveedorNit:     (s["dj_proveedor_nit"]    && s["dj_proveedor_nit"].trim())    || "901.789.698",
